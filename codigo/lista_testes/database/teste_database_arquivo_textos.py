...
class TesteDatabaseArquivoTextos(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.CLASSE_TESTADA.set_arquivo_processado(ArquivoTextoObject(0,'texto_1','','trie'))
        self.CLASSE_TESTADA.set_arquivo_processado(ArquivoTextoObject(0,'texto_2','','trie'))
    ...
    def teste_2(self):
        ...
        arq = ArquivoTextoObject(0,'texto_3','','trie')
        resultado = self.CLASSE_TESTADA.set_arquivo_processado(arq)
        self.assertEqual(resultado, 3)

    def teste_3(self):
        '''Testa se a classe insere um texto que já existe'''
    ...
    def teste_5(self):
        ...
        with self.assertRaises(ValueError):
            self.CLASSE_TESTADA.set_arquivo_processado(ArquivoTextoObject(id=0,nome='',descricao='',modelo_processamento='trie'))
    
    def teste_6(self):
        '''Testa se a classe não permite salvar nome com modelo_processamento vazio'''
        with self.assertRaises(ValueError):
            self.CLASSE_TESTADA.set_arquivo_processado(ArquivoTextoObject(id=0,nome='texto_3',descricao='',modelo_processamento=''))

    def teste_6_1(self):
        '''Testa se a classe não permite salvar nome com modelo_processamento de formato invalido'''
        with self.assertRaises(ValueError):
            self.CLASSE_TESTADA.set_arquivo_processado(ArquivoTextoObject(id=0,nome='texto_3',descricao='',modelo_processamento=1))

    def teste_6_2(self):
        '''Testa se a classe não permite salvar nome com nome de formato invalido'''
        with self.assertRaises(ValueError):
            self.CLASSE_TESTADA.set_arquivo_processado(ArquivoTextoObject(id=0,nome=1,descricao='',modelo_processamento='trie'))
